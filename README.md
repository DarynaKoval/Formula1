...
**Примітка:** Флаг `-ea` обов'язковий для assertions.

## Вимоги до проєкту

- ООП принципи: Наслідування, Інкапсуляція, Поліморфізм, Абстракція
- Ієрархія виключень: F1Exception, FuelException, TireException, RaceException
- GRASP принципи: Creator, Information Expert, Low Coupling, High Cohesion, Controller
- Породжувальні шаблони: Factory Method, Builder, Singleton
- Поведінкові шаблони: Strategy, State, Observer
- Структурні шаблони: Adapter, Decorator
- TDD: Повне тестове покриття
- Рефакторинг: Validator, константи
- UML діаграма: PlantUML формат
...
- Етап 5: Поведінкові шаблони
- Етап 6: Структурні шаблони
- Етап 7: TeamPrincipal та логіка команди
- Етап 8: Симуляція гонки
- Етап 9: Система балів та результати
- Етап 10: Повне TDD
- Етап 11: Рефакторинг
- Етап 12: Головний клас та інтеграція
- Етап 13: UML діаграма

## Автор

Студентський проєкт з об'єктно-орієнтованого програмування.
